...
struct QuizsViewIphone_Previews: PreviewProvider {
    static var previews: some View {
        QuizsViewIphone(quickQuizNbQuestions: .init(wrappedValue: 10.0, "quick-quiz-nb-questions"))
    }
}
